...
import { Settings, Database, Globe, Shield, Zap, Brain, Eye, ToggleLeft, ToggleRight, Save, RefreshCw, Monitor } from 'lucide-react';
                  ...
                  {section.settings.map((setting) => (
                    ...
                    >
                      ...
                      <div className="ml-4">
                        {setting.type === 'toggle' && (
                          <button
                            onClick={() => 'value' in setting ? updateSetting(setting.key, !setting.value) : undefined}
                            className={`p-1 rounded-full transition-colors ${
                              ('value' in setting ? setting.value : false) ? 'text-glow-purple' : isDark ? 'text-slate-400' : 'text-slate-500'
                            }`}
                          >
                            {('value' in setting ? setting.value : false) ? (
                        ...
                        {setting.type === 'action' && (
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            onClick={'action' in setting ? setting.action : undefined}
                          ...
                          >
                            {('actionText' in setting ? setting.actionText : '')}
                          </motion.button>
                        )}
                      </div>
                    </div>
