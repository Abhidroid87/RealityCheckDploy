...
import { ArrowLeft, Baseline as Timeline, Calendar, TrendingUp, Brain, Share2, Download, SkipBack, Pause, Play, SkipForward, MessageSquare } from 'lucide-react';
...
const EventTimelinePage: React.FC = () => {
  ...
  const loadTimeline = async () => {
    ...
    try {
      ...
      const processedEvents = timelineData.timeline.map((event) => ({
        ...event,
