      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
            {[
              { label: 'Total Articles', value: stats.total, icon: Zap, color: 'blue' },
              { label: 'Verified', value: stats.verified, icon: Zap, color: 'green' },
              { label: 'Suspicious', value: stats.suspicious, icon: Zap, color: 'red' },
      ...
      <main className="relative z-10 px-6 py-8 pb-12">
        <div className="max-w-7xl mx-auto">
          {loading ? (
            ...
            >
              <Zap className={`w-16 h-16 mx-auto mb-4 transition-colors ${
