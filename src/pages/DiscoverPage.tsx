...
import { Zap, Brain, Target, RefreshCw, X } from 'lucide-react';
...
const DiscoverPage: React.FC = () => {
  ...
  const categories = [
    { id: 'trending', name: 'Trending Now', icon: Zap, color: 'from-red-500 to-orange-500' },
    ...
    { id: 'climate', name: 'Climate', icon: Zap, color: 'from-teal-500 to-blue-500' },
    { id: 'business', name: 'Business', icon: Zap, color: 'from-yellow-500 to-orange-500' },
    { id: 'science', name: 'Science', icon: Zap, color: 'from-indigo-500 to-purple-500' }
  ];
    ...
    try {
      ...
      try {
        ...
        searchArticles = searchResults.results.map((result: any) => ({
          id: Math.random().toString(36).substr(2, 9), // result: any
          title: result.title,
        ...
        >
          <div className="flex gap-4">
            <div className="flex-1 relative">
              <Zap className={`absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 transition-colors ${
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between text-xs">
                              <div className="flex items-center space-x-2">
                                <Zap className="w-3 h-3 text-glow-purple" />
        ...
        {showTimelineModal && selectedArticle && (
          ...
          >
            ...
            >
              ...
              {loadingTimeline ? (
                <div className="text-center py-12">
                  <Zap className="w-12 h-12 text-glow-purple mx-auto mb-4 animate-pulse" />
                  <p className={`text-lg font-semibold transition-colors ${
                    isDark ? 'text-white' : 'text-slate-900'
                  }`}>
                    Generating Timeline...
